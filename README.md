**You should read "/(version of assets pack)/password.txt" if the archive ask for password. Don't worry if you don't see the file. That's because the archive has no password.
